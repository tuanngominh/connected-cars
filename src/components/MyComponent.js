    ...
    return (
      <div className="container">
        <div className=".col-xs-12 .col-md-8 .col-md-off-set-2">
          ...
          <p>
            <img src={imgSource} className="img-responsive" alt="Responsive image"/><br/>
            (Image from <a href="https://pixabay.com/en/milk-splash-milk-cherry-spoon-2064088/" target="_blank">pixalbay</a>)
          </p>
